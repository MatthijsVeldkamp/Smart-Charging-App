            ...
            @foreach($sockets as $socket)
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('sockets.data', $socket) }}" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Gegevens</a>
                    </div>
                </div>
            @endforeach
        </div>
